scripts.day12_2 = async () => {
    ...
    let starts = allNodes.filter(n => n.height == 0 && n.solved);
    starts.sort((a,b) => a.distance - b.distance);
    terminal.textContent = `Minimum distance from 'a' elevation: ${starts[0].distance} located at [${starts[0].x},${starts[0].y}]`;
}